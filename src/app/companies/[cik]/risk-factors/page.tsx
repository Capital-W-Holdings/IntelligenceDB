  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      <div className="mb-4 sm:mb-6">
        <Link href={`/companies/${cik}`}>
          <Button variant="outline" size="sm" className="h-9">← Back</Button>
        </Link>
      </div>

      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6 sm:mb-8">
        <div>
          <h1 className="text-xl sm:text-3xl font-bold text-gray-900">Risk Factor Analysis</h1>
          <p className="text-sm sm:text-base text-gray-600 mt-1">
            {data.company?.name} {data.company?.ticker && `(${data.company.ticker})`}
          </p>
        ...
        <div className="flex items-center justify-between sm:block sm:text-right">
          <div className="text-xs sm:text-sm text-gray-500 sm:mb-1">Severity</div>
          <Badge className={`${severityColors[analysis.overallSeverity]} text-white text-sm sm:text-lg px-3 sm:px-4 py-0.5 sm:py-1`}>
