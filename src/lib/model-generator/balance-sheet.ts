...
import { ModelSheet, ModelLineItem, ModelProvenance, BALANCE_SHEET_ITEMS } from './types'

const SEC_ARCHIVES_BASE = 'https://www.sec.gov/Archives/edgar/data'

/**
 * Build balance sheet model from XBRL data
 */
export function buildBalanceSheet(
  ...
  for (const itemDef of BALANCE_SHEET_ITEMS) {
